namespace HomeWorkfirst.Models
{
	public static class RepositoryHelper
	{
		...
		public static CustomerDetailsViewRepository GetCustomerDetailsViewRepository()
		{
			var repository = new CustomerDetailsViewRepository();
			repository.UnitOfWork = GetUnitOfWork();
			return repository;
		}

		public static CustomerDetailsViewRepository GetCustomerDetailsViewRepository(IUnitOfWork unitOfWork)
		{
			var repository = new CustomerDetailsViewRepository();
